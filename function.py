...
import numpy as np
import random
from data.cuhkpedes import CUHKPEDESDataset
...
def data_config(dir, batch_size, split, max_length, embedding_type,transform):
    ...
    if embedding_type == 'BERT':
        ...
        data_split = CUHKPEDESDataset(dir, split, max_length, transform)
