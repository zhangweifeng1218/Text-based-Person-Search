...
def parse_args():
    ...
    parser.add_argument('--offline_bert', type=bool, default=True)
    parser.add_argument('--bert_model_path', type=str, default='./pretrained/')
    ...
    parser.add_argument('--RNAlign', default=True)
    parser.add_argument('--IDLoss', default=True)
